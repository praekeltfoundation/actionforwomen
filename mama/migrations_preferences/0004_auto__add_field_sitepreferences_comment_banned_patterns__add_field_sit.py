...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitePreferences.comment_banned_patterns'
        db.add_column('preferences_sitepreferences', 'comment_banned_patterns',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SitePreferences.comment_silenced_patterns'
        db.add_column('preferences_sitepreferences', 'comment_silenced_patterns',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitePreferences.comment_banned_patterns'
        db.delete_column('preferences_sitepreferences', 'comment_banned_patterns')

        # Deleting field 'SitePreferences.comment_silenced_patterns'
        db.delete_column('preferences_sitepreferences', 'comment_silenced_patterns')
