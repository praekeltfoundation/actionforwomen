...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.computed_delivery_date'
        db.delete_column('mama_userprofile', 'computed_delivery_date')

        # Adding field 'UserProfile.delivery_date'
        db.add_column('mama_userprofile', 'delivery_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.computed_delivery_date'
        db.add_column('mama_userprofile', 'computed_delivery_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.delivery_date'
        db.delete_column('mama_userprofile', 'delivery_date')
