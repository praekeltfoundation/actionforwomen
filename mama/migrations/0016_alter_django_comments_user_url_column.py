...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('django_comments', 'user_url', models.TextField())

    def backwards(self, orm):
        # Existing definition is varchar(200)
        # No need for a backward migration
        # New data longer than varchar(200) would break
        pass
