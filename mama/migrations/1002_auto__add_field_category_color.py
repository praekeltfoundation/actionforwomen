...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('category_category', 'color',
                      self.gf('django.db.models.fields.CharField')(default='orange', max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.color'
        db.delete_column('category_category', 'color')


    models = {
        'category.category': {
            'Meta': {'ordering': "('title',)", 'object_name': 'Category'},
            'color': ('django.db.models.fields.CharField', [], {'default': "'orange'", 'max_length': '64', 'null': 'True', 'blank': 'True'}),
