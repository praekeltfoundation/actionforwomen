...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mama_userprofile', 'relation_to_baby',
        ...
        db.add_column('mama_userprofile', 'unknown_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('mama_userprofile', 'relation_to_baby')

        # Deleting field 'UserProfile.date_qualifier'
        db.delete_column('mama_userprofile', 'date_qualifier')

        # Deleting field 'UserProfile.unknown_date'
        db.delete_column('mama_userprofile', 'unknown_date')
