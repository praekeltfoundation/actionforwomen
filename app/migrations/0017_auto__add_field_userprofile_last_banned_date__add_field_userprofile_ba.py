...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_banned_date'
        db.add_column('mama_userprofile', 'last_banned_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.ban_duration'
        db.add_column('mama_userprofile', 'ban_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.accepted_commenting_terms'
        db.add_column('mama_userprofile', 'accepted_commenting_terms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_banned_date'
        db.delete_column('mama_userprofile', 'last_banned_date')

        # Deleting field 'UserProfile.ban_duration'
        db.delete_column('mama_userprofile', 'ban_duration')

        # Deleting field 'UserProfile.accepted_commenting_terms'
        db.delete_column('mama_userprofile', 'accepted_commenting_terms')
