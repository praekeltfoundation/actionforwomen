...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.relation_to_baby'
        db.delete_column('app_userprofile', 'relation_to_baby')

        # Deleting field 'UserProfile.delivery_date'
        db.delete_column('app_userprofile', 'delivery_date')

        # Deleting field 'UserProfile.weeks_pregnant_signup'
        db.delete_column('app_userprofile', 'weeks_pregnant_signup')


    def backwards(self, orm):
        # Adding field 'UserProfile.relation_to_baby'
        db.add_column('app_userprofile', 'relation_to_baby',
                      self.gf('django.db.models.fields.CharField')(default='mom_or_mom_to_be', max_length=30),
                      keep_default=False)

        # Adding field 'UserProfile.delivery_date'
        db.add_column('app_userprofile', 'delivery_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.weeks_pregnant_signup'
        db.add_column('app_userprofile', 'weeks_pregnant_signup',
    ...
    models = {
        ...
        'app.imageheading': {
            'Meta': {'object_name': 'ImageHeading'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_heading_style': ('django.db.models.fields.CharField', [], {'default': "'light'", 'max_length': '30'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'image_heading_target_set'", 'to': "orm['jmbo.ModelBase']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'image_heading_source_set'", 'to': "orm['jmbo.ModelBase']"})
        },
        'app.link': {
        ...
        'app.userprofile': {
            ...
            'engage_anonymously': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identity': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
