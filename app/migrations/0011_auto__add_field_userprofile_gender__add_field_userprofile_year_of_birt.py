...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_userprofile', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.year_of_birth'
        db.add_column('app_userprofile', 'year_of_birth',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.identity'
        db.add_column('app_userprofile', 'identity',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('app_userprofile', 'gender')

        # Deleting field 'UserProfile.year_of_birth'
        db.delete_column('app_userprofile', 'year_of_birth')

        # Deleting field 'UserProfile.identity'
        db.delete_column('app_userprofile', 'identity')
