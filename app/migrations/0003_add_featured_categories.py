...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        if not Category.objects.filter(slug='featured').exists():
            Category.objects.create(title='Featured', slug='featured')

    def backwards(self, orm):
        Category = orm['category.Category']
        if Category.objects.filter(slug='featured').exists():
            Category.objects.get(slug='featured').delete()
