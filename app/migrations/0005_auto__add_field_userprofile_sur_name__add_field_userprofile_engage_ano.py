...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.sur_name'
        db.add_column('app_userprofile', 'sur_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.engage_anonymously'
        db.add_column('app_userprofile', 'engage_anonymously',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.sur_name'
        db.delete_column('app_userprofile', 'sur_name')

        # Deleting field 'UserProfile.engage_anonymously'
        db.delete_column('app_userprofile', 'engage_anonymously')
    ...
    models = {
        ...
        'app.userprofile': {
            ...
            'sur_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
