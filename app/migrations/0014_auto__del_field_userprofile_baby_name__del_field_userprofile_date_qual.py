...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.baby_name'
        db.delete_column('app_userprofile', 'baby_name')

        # Deleting field 'UserProfile.date_qualifier'
        db.delete_column('app_userprofile', 'date_qualifier')


    def backwards(self, orm):
        # Adding field 'UserProfile.baby_name'
        db.add_column('app_userprofile', 'baby_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.date_qualifier'
        db.add_column('app_userprofile', 'date_qualifier',
