...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_reset_date'
        db.add_column('mama_userprofile', 'last_reset_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.reset_count'
        db.add_column('mama_userprofile', 'reset_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_reset_date'
        db.delete_column('mama_userprofile', 'last_reset_date')

        # Deleting field 'UserProfile.reset_count'
        db.delete_column('mama_userprofile', 'reset_count')
