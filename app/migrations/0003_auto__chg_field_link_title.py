...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mama_link', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Link.title'
        db.alter_column('mama_link', 'title', self.gf('django.db.models.fields.CharField')(default='Link Title', max_length=256))
