...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageHeading'
        db.create_table('app_imageheading', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_heading_style', self.gf('django.db.models.fields.CharField')(default='light', max_length=30)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='image_heading_target_set', to=orm['jmbo.ModelBase'])),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='image_heading_source_set', to=orm['jmbo.ModelBase'])),
        ))
        db.send_create_signal('app', ['ImageHeading'])


    def backwards(self, orm):
        # Deleting model 'ImageHeading'
        db.delete_table('app_imageheading')
    ...
    models = {
        ...
        'app.imageheading': {
            'Meta': {'ordering': "['id']", 'object_name': 'ImageHeading'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'app.userprofile': {
            ...
            'engage_anonymously': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
