...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field contact_email_recipients on 'SitePreferences'
        db.create_table('preferences_sitepreferences_contact_email_recipients', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sitepreferences', models.ForeignKey(orm['preferences.sitepreferences'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('preferences_sitepreferences_contact_email_recipients', ['sitepreferences_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field contact_email_recipients on 'SitePreferences'
        db.delete_table('preferences_sitepreferences_contact_email_recipients')
