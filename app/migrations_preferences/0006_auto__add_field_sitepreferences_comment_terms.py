...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitePreferences.comment_terms'
        db.add_column('preferences_sitepreferences', 'comment_terms',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitePreferences.comment_terms'
        db.delete_column('preferences_sitepreferences', 'comment_terms')
