...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SitePreferences.hivaids_helpline_number'
        db.delete_column('preferences_sitepreferences', 'hivaids_helpline_number')

        # Deleting field 'SitePreferences.baby_helpline_number'
        db.delete_column('preferences_sitepreferences', 'baby_helpline_number')

        # Deleting field 'SitePreferences.pregnancy_helpline_number'
        db.delete_column('preferences_sitepreferences', 'pregnancy_helpline_number')


    def backwards(self, orm):
        # Adding field 'SitePreferences.hivaids_helpline_number'
        db.add_column('preferences_sitepreferences', 'hivaids_helpline_number',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SitePreferences.baby_helpline_number'
        db.add_column('preferences_sitepreferences', 'baby_helpline_number',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SitePreferences.pregnancy_helpline_number'
        db.add_column('preferences_sitepreferences', 'pregnancy_helpline_number',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)
