...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitePreferences.commenting_time_on'
        db.add_column('preferences_sitepreferences', 'commenting_time_on',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SitePreferences.commenting_time_off'
        db.add_column('preferences_sitepreferences', 'commenting_time_off',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitePreferences.commenting_time_on'
        db.delete_column('preferences_sitepreferences', 'commenting_time_on')

        # Deleting field 'SitePreferences.commenting_time_off'
        db.delete_column('preferences_sitepreferences', 'commenting_time_off')
