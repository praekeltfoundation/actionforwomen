...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SitePreferences.faqs'
        db.add_column('preferences_sitepreferences', 'faqs',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SitePreferences.faqs'
        db.delete_column('preferences_sitepreferences', 'faqs')
    ...
    models = {
        ...
        'preferences.sitepreferences': {
            ...
            'faqs': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
